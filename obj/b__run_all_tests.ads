...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#d1a27de6#;
   ...
   u00137 : constant Version_32 := 16#3600ec5c#;
   pragma Export (C, u00137, "run_tests_casehashiB");
   u00138 : constant Version_32 := 16#b5ae3e92#;
   pragma Export (C, u00138, "a_tester_casehashiB");
   u00139 : constant Version_32 := 16#182cb654#;
   pragma Export (C, u00139, "a_tester_casehashiS");
   u00140 : constant Version_32 := 16#d0d7fcdc#;
   pragma Export (C, u00140, "casehashiB");
   u00141 : constant Version_32 := 16#7778fdaf#;
   pragma Export (C, u00141, "casehashiS");
   u00142 : constant Version_32 := 16#e5d5b101#;
   pragma Export (C, u00142, "coordonneeB");
   u00143 : constant Version_32 := 16#b1b28967#;
   pragma Export (C, u00143, "coordonneeS");
   u00144 : constant Version_32 := 16#32a6c5c0#;
   pragma Export (C, u00144, "ileB");
   u00145 : constant Version_32 := 16#1bebeeec#;
   pragma Export (C, u00145, "ileS");
   u00146 : constant Version_32 := 16#2535b7d4#;
   pragma Export (C, u00146, "orientationB");
   u00147 : constant Version_32 := 16#67230454#;
   pragma Export (C, u00147, "orientationS");
   u00148 : constant Version_32 := 16#4130ca92#;
   pragma Export (C, u00148, "pontB");
   u00149 : constant Version_32 := 16#e5c3dea1#;
   pragma Export (C, u00149, "pontS");
   u00150 : constant Version_32 := 16#d4fe5859#;
   pragma Export (C, u00150, "typecaseB");
   u00151 : constant Version_32 := 16#ea991bf5#;
   pragma Export (C, u00151, "typecaseS");
   u00152 : constant Version_32 := 16#42b36dfe#;
   pragma Export (C, u00152, "ada__strings__unboundedB");
   u00153 : constant Version_32 := 16#da258d18#;
   pragma Export (C, u00153, "ada__strings__unboundedS");
   u00154 : constant Version_32 := 16#bb264ce2#;
   pragma Export (C, u00154, "ada__strings__searchB");
   u00155 : constant Version_32 := 16#73987e07#;
   pragma Export (C, u00155, "ada__strings__searchS");
   u00156 : constant Version_32 := 16#a1d6147d#;
   pragma Export (C, u00156, "system__compare_array_unsigned_8B");
   u00157 : constant Version_32 := 16#86f92099#;
   ...
   u00173 : constant Version_32 := 16#b3974e02#;
   pragma Export (C, u00173, "types_testsS");
   u00174 : constant Version_32 := 16#e89931a4#;
   pragma Export (C, u00174, "run_tests_coordonneesB");
   u00175 : constant Version_32 := 16#d19c2937#;
   pragma Export (C, u00175, "a_tester_coordonneesB");
   u00176 : constant Version_32 := 16#e0ab18df#;
   pragma Export (C, u00176, "a_tester_coordonneesS");
   u00177 : constant Version_32 := 16#0f1e3fa5#;
   pragma Export (C, u00177, "run_tests_grilleB");
   u00178 : constant Version_32 := 16#b11063d9#;
   pragma Export (C, u00178, "a_tester_grilleB");
   u00179 : constant Version_32 := 16#dc04062e#;
   pragma Export (C, u00179, "a_tester_grilleS");
   u00180 : constant Version_32 := 16#3a9aa9b7#;
   pragma Export (C, u00180, "affichageB");
   u00181 : constant Version_32 := 16#d73cd0b9#;
   pragma Export (C, u00181, "affichageS");
   u00182 : constant Version_32 := 16#143db104#;
   pragma Export (C, u00182, "grilleB");
   u00183 : constant Version_32 := 16#cf426640#;
   pragma Export (C, u00183, "grilleS");
   u00184 : constant Version_32 := 16#12577bdd#;
   pragma Export (C, u00184, "resolution_hashiB");
   u00185 : constant Version_32 := 16#d56309ca#;
   pragma Export (C, u00185, "resolution_hashiS");
   u00186 : constant Version_32 := 16#98bd50de#;
   pragma Export (C, u00186, "run_tests_ilesB");
   u00187 : constant Version_32 := 16#af3884f5#;
   pragma Export (C, u00187, "a_tester_ileB");
   u00188 : constant Version_32 := 16#906804ca#;
   pragma Export (C, u00188, "a_tester_ileS");
   u00189 : constant Version_32 := 16#63bb70e1#;
   pragma Export (C, u00189, "run_tests_orientationB");
   u00190 : constant Version_32 := 16#e4da742c#;
   pragma Export (C, u00190, "a_tester_orientationB");
   u00191 : constant Version_32 := 16#f6a72759#;
   pragma Export (C, u00191, "a_tester_orientationS");
   u00192 : constant Version_32 := 16#ef372b06#;
   pragma Export (C, u00192, "run_tests_pontsB");
   u00193 : constant Version_32 := 16#9428e1b3#;
   pragma Export (C, u00193, "a_tester_pontB");
   u00194 : constant Version_32 := 16#0d747cd9#;
   pragma Export (C, u00194, "a_tester_pontS");
   u00195 : constant Version_32 := 16#7141fd9f#;
   pragma Export (C, u00195, "run_tests_typecaseB");
   u00196 : constant Version_32 := 16#4c1aa6c4#;
   pragma Export (C, u00196, "a_tester_typecaseB");
   u00197 : constant Version_32 := 16#66a822f9#;
   pragma Export (C, u00197, "a_tester_typecaseS");
   u00198 : constant Version_32 := 16#a078e4d8#;
   pragma Export (C, u00198, "tests_resolution_hashiB");
   u00199 : constant Version_32 := 16#d18c3cc5#;
   pragma Export (C, u00199, "remplir_grille_hashiB");
   u00200 : constant Version_32 := 16#ee11813b#;
   pragma Export (C, u00200, "remplir_grille_hashiS");
   ...
   --  affichage%s
   --  affichage%b
   --  remplir_grille_hashi%s
   --  remplir_grille_hashi%b
   --  tests_resolution_hashi%b
   --  types_tests%s
   --  a_tester_casehashi%s
   --  a_tester_casehashi%b
   ...
   --  a_tester_ile%s
   --  a_tester_ile%b
   --  a_tester_orientation%s
   --  a_tester_orientation%b
   --  a_tester_pont%s
   --  a_tester_pont%b
   --  a_tester_typecase%s
   --  a_tester_typecase%b
   --  run_tests_casehashi%b
   --  run_tests_coordonnees%b
   --  run_tests_grille%b
   --  run_tests_iles%b
   --  run_tests_orientation%b
   --  run_tests_ponts%b
   --  run_tests_typecase%b
   --  run_all_tests%b
