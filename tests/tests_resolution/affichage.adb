...
package body Affichage is
   ...
   begin
      ...
      put("Nord  "); AfficherCoordonnee(ObtenirCoordonnee(s(1).Element)); AfficherCase(s(1).Element); New_Line;
      put("Sud   "); AfficherCoordonnee(ObtenirCoordonnee(s(2).Element)); AfficherCase(s(2).Element); New_Line;
      put("Est   "); AfficherCoordonnee(ObtenirCoordonnee(s(3).Element)); AfficherCase(s(3).Element); New_Line;
      put("Ouest "); AfficherCoordonnee(ObtenirCoordonnee(s(4).Element)); AfficherCase(s(4).Element); New_Line;
